(function () {
  ...
  $(function(){
    var obj = $('.menu-sub>li');
    var obj1 = $('.menu-sub>ul');
    obj1.eq(0).addClass('show');
    obj.click(function(){
      var index = obj.index(this);
      obj1.removeClass('show');
      obj1.eq(index).addClass('show');
    });
  });
  ...
  function initSubHeaders () {
    ...
    function updateSidebar () {
      ...
      $('.menu-sub>ul').removeClass('show');
      $('.menu-sub>li>.active').parent('li').next('ul').addClass('show');
      $('.menu-sub>ul>li>.active').parent('li').parent('ul').addClass('show');
    }
